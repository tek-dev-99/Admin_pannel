...
require_once('lglib/user_lib.php');
?>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          <thead>
            <tr>
              ...
              <th scope="col"><a href="user.php?sort=user_id&order=<?php  echo $order; ?><?php echo $page_url;?>">ID<?php if ($sort=='user_id') {?><i class="fas fa-sort-<?php echo ($order=='ASC')?'down':'up';?>"></i><?php }?> </a></th>
              <th scope="col"><a href="user.php?sort=name&order=<?php  echo $order; ?><?php echo $page_url;?>">username<?php if ($sort=='name') {?><i class="fas fa-sort-<?php echo ($order=='ASC')?'down':'up';?>"></i><?php }?></a></th>
              <th scope="col"><a href="user.php?sort=email&order=<?php  echo $order; ?><?php echo $page_url;?>">email<?php if ($sort=='email') {?><i class="fas fa-sort-<?php echo ($order=='ASC')?'down':'up';?>"></i><?php }?></a></th>
              <th scope="col"><a href="user.php?sort=phone&order=<?php  echo $order; ?><?php echo $page_url;?>">phone<?php if ($sort=='phone') {?><i class="fas fa-sort-<?php echo ($order=='ASC')?'down':'up';?>"></i><?php }?></a></th>
            
              <!--  <th scope="col"><a href="user.php?sort=photo&order=<?php  echo $order; ?><?php echo $page_url;?>">Photo<?php if ($sort=='photo') {?><i class="fas fa-sort-<?php echo ($order=='ASC')?'down':'up';?>"></i><?php }?></a></th>-->
				<th scope="col"><a href="user.php?sort=msg&order=<?php  echo $order; ?><?php echo $page_url;?>">Message<?php if ($sort=='msg') {?><i class="fas fa-sort-<?php echo ($order=='ASC')?'down':'up';?>"></i><?php }?></a></th>
              <th scope="col"><a href="user.php?sort=status&order=<?php  echo $order; ?><?php echo $page_url;?>">status<?php if ($sort=='status') {?><i class="fas fa-sort-<?php echo ($order=='ASC')?'down':'up';?>"></i><?php }?></a></th>
              <th scope="col"><a href="user.php?sort=date&order=<?php  echo $order; ?><?php echo $page_url;?>">date<?php if ($sort=='date') {?><i class="fas fa-sort-<?php echo ($order=='ASC')?'down':'up';?>"></i><?php }?></a> </th>
              <th scope="col">Action</th>
	        </tr>
			<tr>
				<td></td>
				<td> <input type="text" size="1" name="filter_user_id" id="filter_user_id"	value="<?php echo $filter_user_id;?>" /> </td>
				<td> <input type="text" size="5" name="filter_name" id="filter_name"	value="<?php echo $filter_name;?>" /> </td>
				...
				<!--<td> <input type="text" size="5" name="filter_photo" id="filter_photo"	value="<?php echo $filter_photo;?>" /> -->
					<td> <input type="text" size="5" name="filter_msg" id="filter_msg"	value="<?php echo $filter_msg;?>" /> </td>
				</td>
		...
		<?php foreach($data_users as $data_user){ ?>
          ...
          <td><?php echo $data_user['phone']; ?></td>
				...
				<td><?php echo $data_user['msg']; ?></td>
          <td><?php echo ($data_user['status'] == 1)?'Active':'Inactive'; ?></td>
          <td><?php echo $data_user['date_added']; ?></td>
          <td><a href="user_edit.php ? user_id=<?php echo $data_user['user_id']; ?>" >Edit</a>
		  |  
		  <a data="user.php?action=delete&user_id=<?php echo $data_user['user_id']; ?>" onclick="confirmation(this)" >Delete</a></td>                  
		...
		<?php if($total_user>$page_limit){ ?>
			<nav aria-label="...">
				<ul class="pagination ">
				  ...
				  <?php if($page>1) { ?>
				  <li class="page-item ">
					  <a class="page-link" href="user.php?page=<?php echo $page-1; ?><?php echo $sort_url;?>" >Previous</a></li>
				  <?php } else { ?>
				...
				<li class="page-item <?php echo ($page == $n)?'active':'';?>"><a class="page-link" href="user.php?page=<?php echo $n; ?><?php echo $sort_url;?>"><?php echo $n; ?></a></li>
			<?php } ?>
				
					  <?php if($page<$n-1) { ?>
				  <li class="page-item ">
					  <a class="page-link" href="user.php?page=<?php echo $page+1; ?><?php echo $sort_url;?>" >Next</a></li>
				  <?php } else { ?>
				  <li class="page-item disabled">
...
<script type="text/javascript">
		...
		$('.btnFilter').click(function(){
			...
			var filter_msg=$('#filter_msg').val();
			if(filter_msg !=''){
				filter_url+='&filter_msg='+filter_msg;
			}
