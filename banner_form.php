<?php
 ...
 require_once('lglib/banner_form_lib.php');
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
 ...
 <form  method="POST" action="" enctype="multipart/form-data" >
  <div class="mb-3">
    <label for="banner_title" class="form-label">Banner_Title</label>
    <input type="text" name="banner_title" id="banner_title" class=" form-control" value="<?php echo $banner_title ?>"  >
     </div>
	...
	<tr>
	<td><?php echo  $additional_photos_1['product_id']; ?> </td>
